...
class Interface:
    def __init__(self, name: str, device_name: Optional[str] = None) -> None:
        ...
        # self.connected_to: List["Interface"] = []
    ...
    # def connect_to(self, interface: "Interface") -> None:
    #     if interface in self.connected_to:
    #         raise ValueError(f"Interface {interface} is already connected to {self}")
